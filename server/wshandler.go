...
func serveWebSocket(wrt http.ResponseWriter, req *http.Request) {
	...
	ws, err := websocket.Upgrade(wrt, req, nil, 1024, 1024)
	...
	sess := sessionStore.Create(ws, appid)

	sess.writePkt(&ServerComMessage{Ctrl: &MsgServerCtrl{
		Code:   http.StatusCreated,
		Text:   http.StatusText(http.StatusCreated),
		Params: map[string]interface{}{"protocol": VERSION}}})
